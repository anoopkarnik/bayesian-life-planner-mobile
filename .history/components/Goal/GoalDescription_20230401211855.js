    ...
    <SafeAreaView className="bg-black flex-1">
      <ScrollView className="my-10">
        ...
        <View className="flex-row bg-gray-800 py-2">
          ...
          <View className="flex-row bg-gray-800 py-2">
            <Text className="text-white text-xl">Current Level : {Math.round(props.records.completedPercentage)}</Text>
          </View>
          <View className="flex-row bg-gray-800 py-2">
            <Text className="text-white text-xl">Aggregated Subgoals Level : {Math.round(props.childCompletedPercentage)}</Text>
          </View>
          <View className="flex-row bg-gray-800 py-2">
            <Text className="text-white text-xl">Working Level : {Math.round(props.records.workPercentage)}</Text>
          </View>
          <View className="flex-row bg-gray-800 py-2">
