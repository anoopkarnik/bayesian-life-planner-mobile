import { View, Button,Text,SafeAreaView,ScrollView,TouchableOpacity,TextInput } from 'react-native'
    ...
    <SafeAreaView className="bg-black flex-1">
      <ScrollView className="my-10">
        ...
        <View>
          ...
          <View className="flex-row">
            <Text className="text-white text-xl">name : 
              {isEditing?
             <TextInput className="bg-gray-300 flex-1 text-xl" Name='text' 
              value={nameState} placeholder={String(nameState)} 
          ...
          <View className="flex-row">
            ...
            {isEditing?
            <TextInput className="bg-gray-300 flex-1 text-xl" Name='text' 
             value={streak} placeholder={String(streak)} onChangeText={text => setStreak(text)}/>:
            <Text className="text-white text-xl">{streak}</Text>}
          </View>
          <View className="flex-row">
            ...
            {isEditing?
            <TextInput className="bg-gray-300 flex-1 text-xl" Name='text' 
             value={totalTimes} placeholder={String(totalTimes)} onChangeText={text => setTotalTimes(text)}/>:
            <Text className="text-white text-xl">{totalTimes}</Text>}
          </View>
          <View className="flex-row">
            ...
            {isEditing?
            <TextInput className="bg-gray-300 flex-1 text-xl" Name='text' 
             value={active} placeholder={String(active)} onChangeText={text => setActive(text)}/>:
            <Text className="text-white text-xl">{active}</Text>}
          </View>
          <View className="flex-row">
            ...
            {isEditing?
            <TextInput className="bg-gray-300 flex-1 text-xl" Name='text' 
             value={hidden} placeholder={String(hidden)} onChangeText={text => setHidden(text)}/>:
            <Text className="text-white text-xl">{hidden}</Text>}
          </View>
          <View className="flex-row">
            ...
            {isEditing?
            <TextInput className="bg-gray-300 flex-1 text-xl" Name='text' 
             value={completed} placeholder={String(completed)} onChangeText={text => setCompleted(text)}/>:
            <Text className="text-white text-xl">{completed}</Text>}
          </View>
          <View className="flex-row">
            <Text className="text-white text-xl">every : </Text>
            <Text className="text-white text-xl">{streak}</Text>
          </View>
          <View className="flex-row">
