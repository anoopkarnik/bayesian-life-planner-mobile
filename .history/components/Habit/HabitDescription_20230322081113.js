      ...
      <ScrollView className="my-10">
        ...
        <View className="flex-row">
          ...
          <View>
            ...
            {isEditing?
            <DatePicker options={{backgroundColor: '#090C08', textHeaderColor: '#FFA25B',
              textDefaultColor: '#F6E7C1', selectedTextColor: '#fff', mainColor: '#F4722B',
              textSecondaryColor: '#D6C7A1', borderColor: 'rgba(122, 146, 165, 0.1)',}}
          ...
          <View className="flex-row">
            ...
            {isEditing?
                  ...
                  <Text className="text-white text-xl">{activeState}</Text>}
          </View>
          <View className="flex-row">
            ...
            {isEditing?
                  ...
                  <Text className="text-white text-xl">{hiddenState}</Text>}
          </View>
          <View className="flex-row">
            ...
            {isEditing?
                  ...
                  <Text className="text-white text-xl">{completedState}</Text>}
          </View>
