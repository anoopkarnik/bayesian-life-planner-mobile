...
const HabitItem = (props) => {
	...
	const urgent = "flex flex-row flex-1 bg-[#F2A10F] border-solid border-2"
	const medium ="flex flex-row flex-1 bg-[#FFFF99] border-solid border-2"
	const low ="flex flex-row flex-1 bg-[#FFF] border-solid border-2"
