...
const ConfigureList = (props) => {
  ...
  return (
    <View >
        <TouchableOpacity className="align-middle p-3 px-10 mx-10 bg-gray-600">
      ...
      <View>
        ...
        <View>
            <TextInput
                className="bg-gray-900 p-3 px-10 mx-10 text-white border-solid border-2 border-violet-400"
