      ...
      <ScrollView className="my-10">
        ...
        <View >
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">id </Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{id}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">createdAt</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{formatDate(new Date(createdAt))}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">updatedAt</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{formatDate(new Date(updatedAt))}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">name</Text>
            <Text className="w-1/8 text-white">:</Text>
          ...
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">startDate</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{formatDate(new Date(startDate))}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">dueDate</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{formatDate(new Date(dueDate))}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">habitTypeName</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{habitTypeName}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">streak</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{streak}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">totalTimes</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{totalTimes}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">active</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{active}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">hidden</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{hidden}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">completed</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{completed}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">every</Text>
            <Text className="w-1/8 text-white">:</Text>
            <Text className="w-2/4 text-white">{every}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-3/8 text-white">daysOfWeek </Text>
            <Text className="w-1/8 text-white">:</Text>
