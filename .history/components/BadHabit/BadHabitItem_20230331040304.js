...
import React,{useBadHabite,useContext, useCallback} from 'react'
import { UserContext } from '../../context/UserContext';
import { ConfigContext } from '../../context/ConfigContext';
import { ActiveContext } from '../../context/ActiveContext';
import { completeBadHabit, deleteBadHabit} from '../../api/BadHabitAPI';
...
const BadHabitItem = (props) => {
	...
	const [showChildBadHabits, setShowChildBadHabits] = useBadHabite(false);
    ...
    <View className="flex">
        <View className="flex flex-row flex-1">
            <View className="w-3/5 flex-row">
                {props.record.badHabitsResponses.length>0?<>
                {showChildBadHabits?
        ...
        {showChildBadHabits?
          <View>
            {props.record.badHabitsResponses.map((record)=>(
