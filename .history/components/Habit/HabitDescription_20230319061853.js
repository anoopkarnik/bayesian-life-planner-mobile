    ...
    <SafeAreaView className="bg-black flex-1">
      <ScrollView className="my-10">
        ...
        <View >
          ...
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">createdAt : {createdAt}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{createdAt}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">updatedAt : {updatedAt}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{updatedAt}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">name : {name}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{name}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">scheduleType : {scheduleType}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{scheduleType}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">timeOfDay : {timeOfDay}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{timeOfDay}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">timeTaken : {timeTaken}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{timeTaken}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">startDate : {startDate}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{startDate}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">dueDate : {dueDate}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{dueDate}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">habitTypeName : {habitTypeName}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{habitTypeName}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">streak : {streak}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{streak}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">totalTimes : {totalTimes}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{totalTimes}</Text>
          </View>
          <View className="flex flex-row">
            <Text className="w-1/4 text-white">description : {description}</Text>
            <Text className="w-1/4 text-white">:</Text>
            <Text className="w-2/4 text-white">{description}</Text>
          </View>
          <View className="flex flex-row">
