...
import {PlusCircleIcon,MinusCircleIcon,PencilIcon,XCircleIcon, PlusIcon}  
    ...
    <View className="flex-row items-center ">
        <View className="flex-1">
            {props.record.habitResponses.length>0?<>
                ...
                <Text className="text-l">{props.record.name}</Text>
        </View>
        <Text>
            {props.record.streak}
            <PlusIcon color="black" height={10} width={10}/>
