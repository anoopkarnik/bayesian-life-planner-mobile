...
const TransactionDescription = () => {
  const {params:{id,createdAt,updatedAt,name,startDate,
    ...
    subCategoryName,description,active,hidden,completed,cost}} = useRoute();
    ...
    const onUpdate = async() =>{
      ...
      if(isEditing){
        ...
        nameState,startDateState,accountNameState,accountTypeNameState,
        categoryNameState,expenseNameState,subCategoryNameState,
        descriptionState,costState,activeState,hiddenState,completedState,
        user.id);
        setIsEditing(false);
      }
      else{
  ...
  const onDelete = async() =>{
			await deleteTransaction(config,'Bearer '+user.accessToken,id)
      ...
      <ScrollView>
        ...
        <View>
          <View className="flex-row bg-gray-800 py-2">
            <Text className="text-white text-xl">Account Name: {accountNameState}</Text>
          </View>
          <View className="flex-row bg-gray-800 py-2">
          ...
          <View className="flex-row bg-gray-800 py-2">
            <Text className="text-white text-xl mr-2">cost : </Text>
            {isEditing?
            <TextInput 
            className="flex-1 bg-white text-xl"
          ...
          <View className="flex-row bg-gray-800 py-2">
            ...
            {isEditing?
                  ...
                  selected={expenseNameState?.toString()} className="flex-1 bg-white text-xl">
          ...
          <View className="flex-row bg-gray-800 py-2">
            ...
            {isEditing?
                  ...
                  selected={categoryNameState?.toString()} className="flex-1 bg-white text-xl">
          ...
          <View className="flex-row bg-gray-800 py-2">
            ...
            {isEditing?
                  ...
                  selected={subCategoryNameState?.toString()} className="flex-1 bg-white text-xl">
