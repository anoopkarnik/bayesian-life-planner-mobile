    ...
    <View >
      ...
      <View>
        ...
        <View className="flex-row">
            <TextInput
                className="flex-1 bg-gray-900 p-3 px-10 mx-10 text-white border-solid border-1 border-violet-200"
                placeholder="Name"  placeholderTextColor="#FFF" value={newName}
                onChangeText={text => setNewName(text)}/>    
            <TouchableOpacity className="flex-1 bg-gray-900 p-3 px-10 mx-10" onPress={onCreate}>
