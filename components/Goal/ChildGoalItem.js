...
const ChildGoalItem = (props) => {
  ...
  const navigation = useNavigation();
	...
	const onShowDescription = async() =>{
		...
		navigation.navigate("Description",{id,createdAt,updatedAt,name,dueDate,
      goalTypeName,active,hidden,completed,completedPercentage,workPercentage,description,
    startDate,timeTaken})
	}
  ...
  return (
    <View className="flex">
        <View className="flex flex-row flex-1  mx-6">
