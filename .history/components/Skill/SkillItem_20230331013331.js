...
import TaskDescription from './SkillDescription';
import ChildTaskItem from './ChildSkillItem';
import AddChildTaskForm from './AddChildSkillForm';
        ...
        <View className="flex flex-row flex-1">
            <View className="w-3/5 flex-row">
                ...
                {showChildTasks?
                    ...
                    onPress={()=>setShowChildTasks(false)}/>:
                    <PlusCircleIcon color="black" height={30} width={20}
                    onPress={()=>setShowChildTasks(true)}/>
                }</>:null}
