  ...
  return (
    <View >
      ...
      {showAddCompletedRule?
        <AddCompletedRuleForm key={record.id} record={record} refreshFunction={refreshGoalDescription}/>     
        :null}
      {showAddWorkRule?
        <AddWorkRuleForm key={record.id} record={record} refreshFunction={refreshGoalDescription}/>     
        :null}
   </View>
  )
}
