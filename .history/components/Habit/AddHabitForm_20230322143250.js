  ...
  return (
    <View className="py-3 px-2 bg-gray-600">
      <View className=" flex-row ">
        ...
        <TextInput className="flex-1 mx-2 w-1/4 bg-white p-2"  placeholder="Time Of Day"  
          value={timeOfDay} Name='text' 
          onChangeText={text => setTimeOfDay(text)}/>
        <TextInput 
          className="flex-1 mx-2 w-1/4 bg-white p-2"
      ...
      <View className="flex-row">
          ...
          <SelectPicker className="flex-1 mx-2 w-1/2 bg-white p-2"
            onValueChange={(value)=>setActive(value)} placeholder="Active"
            selected={active}>
            <SelectPicker.Item className="text-gray-400 " label="Yes" value="true"/>
            <SelectPicker.Item className="text-gray-400 " label="No" value="false"/>
        </SelectPicker>
