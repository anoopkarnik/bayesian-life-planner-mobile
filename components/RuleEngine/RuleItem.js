...
const RuleItem = (props) => {
    ...
    var goalTypeName = props.goalTypeName;
  ...
  const navigation = useNavigation();
    ...
    active,hidden,ruleType,weightage,value,conditionType,goalTypeName})
	}

  return (
        <View className="flex-1 flex-row bg-gray-400 py-3 px-2">
