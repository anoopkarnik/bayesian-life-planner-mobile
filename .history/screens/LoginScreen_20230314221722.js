    ...
    <SafeAreaView className="bg-black flex-1 justify-center items-center">
        <View>
            ...
            <View className="flex-1">
                <View>
                    <TextInput
                    className="bg-gray-900 mx-5 my-3 p-3 border-solid border-2 border-violet-400"
                    placeholder="Email."
                ...
                <View className="flex-row justify-center items-center">
                    ...
                    <TouchableOpacity className="bg-black my-5 mx-3 justify-center items-center border-solid border-2 border-violet-400">
