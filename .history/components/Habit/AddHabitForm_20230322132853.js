  ...
  return (
    <View className="py-3 px-2 bg-gray-600">
      <View className=" flex-row ">
        <TextInput className="flex-1 mx-2 w-1/2 bg-white rounded-lg p-2" placeholder="Name"  
          value={name} Name='text' 
          onChangeText={text => setName(text)}/>
        <TextInput className="flex-1 mx-2 w-1/2 bg-white rounded-lg p-2"  placeholder="Time Of Day"  
          value={timeOfDay} Name='text' 
          onChangeText={text => setTimeOfDay(text)}/>
      </View>
      <View className="flex-row">
            <SelectPicker className="flex-1 mx-2 w-1/2 bg-white rounded-lg p-2"
            onValueChange={(value)=>handleScheduleTypeChange(value)} placeholder="Select Schedule Type"
            ...
            <TextInput 
                className="flex-1 mx-2 w-1/2 bg-white rounded-lg p-2"
      ...
      <View className="flex-row">
        ...
        className="flex-1 m-2 w-1/2 bg-gray-800 rounded-lg p-2">
