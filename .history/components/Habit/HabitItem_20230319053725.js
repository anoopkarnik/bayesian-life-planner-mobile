...
const HabitItem = (props) => {
    ...
    var active = String(props.record.active);
    var hidden = String(props.record.hidden);
    var completed = String(props.record.completed);
    var every = props.record.every;
    var daysOfWeek = props.record.daysOfWeek.length==0?"All days":String(props.record.daysOfWeek)
    ...
    <View className="flex-row flex">
        <View className="flex flex-row flex-1">
            <View className="w-2/3 flex-row">
                ...
                <TouchableOpacity >
                    <ArrowTopRightOnSquareIcon color="black" size={20} onPress={onShowDescription}/>
                </TouchableOpacity>
            </View>
