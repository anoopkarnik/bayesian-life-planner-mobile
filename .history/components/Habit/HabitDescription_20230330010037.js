        ...
        <View className="flex-row">
          ...
          <View className='flex-row'>
            <Text className="text-white text-xl ">startDate : </Text>
              ...
              className="flex-1 bg-gray-400 text-xl" placeholder="Start Date">
                <Text className="text-gray-400">{startDateState.getDate()}-
         ...
         :null}
          ...
          <View className='flex-row'>
            ...
            <TouchableOpacity onPress={()=>setShowDueDate(!showDueDate)}
              className="flex-1 bg-gray-400 text-xl" placeholder="Due Date">
                <Text className="text-gray-400">{dueDateState.getDate()}-
