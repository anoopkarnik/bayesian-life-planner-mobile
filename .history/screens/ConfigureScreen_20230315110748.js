...
const ConfigureScreen = () => {
  ...
  return (
    <SafeAreaView className="bg-black flex-1 justify-center items-center my-5">
      <ScrollView>
        <View className="flex-row bg-gray-400 text-lg m-3">
          <View>
              <ConfigureList name="Task Types" records={taskOptions} 
